...
<body>
    ...
    <script>
        ...
        // Fungsi untuk print hasil diagnosa
        function printDiagnosis() {
            ...
            if (printDate) {
                ...
                printDate.textContent = 'Dicetak pada: ' + now.toLocaleDateString('id-ID', options);
            }
        ...
        // Event listener untuk sebelum print
        ...
        // Event listener untuk setelah print
